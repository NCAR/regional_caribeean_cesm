...
nc_sgrd = netCDF4.Dataset('ocean_hgrid.nc')
...
# Mask:
nc_msk = netCDF4.Dataset('ocean_mask.nc')
tmask = nc_msk.variables['mask'][:]
nc_msk.close()

# Topography
nc_topo = netCDF4.Dataset('ocean_topog.nc')
...
filename = 'CARIB_025_grid.nc'
nc = netCDF4.Dataset(filename, 'w', format='NETCDF3_64BIT')
nc.Description = 'MOM6 Caribbean 1/4 degree grid'
# write the author, e.g.,:
nc.Author = 'Your name (your_email@ucar.edu)'
nc.Created = datetime.now().isoformat()
nc.type = 'CARIB_025_grid.nc file'
